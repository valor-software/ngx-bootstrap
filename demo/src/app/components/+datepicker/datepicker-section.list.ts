...
export const datepickerExamples = [
  ...
  },
  {
    ...
    anchor: 'forms',
    name: 'forms',
    description: `<p>Datepicker and daterangepicker can be used in forms. Keep in mind that value of <code>ngModel</code>
...
export const datepickerOldExamples = [
  {
    title: 'Basic',
    anchor: 'basic',
    name: 'old',
