...
import {
  ...
  svLocale, thLocale, trLocale, zhCnLocale
...
const locales = [
  ...
  frLocale, hiLocale, heLocale, huLocale, idLocale, itLocale, jaLocale, koLocale, mnLocale,
  nlLocale, nlBeLocale, plLocale, ptBrLocale, svLocale, ruLocale, zhCnLocale, trLocale, thLocale
];
