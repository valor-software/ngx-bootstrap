...
<demo-section [name]="name" [src]="src">
  ...
  <h3 routerLink="." fragment="basic" id="basic">Timepicker</h3>
  <ng-sample-box [ts]="demos.basic.component" [html]="demos.basic.html">
    <demo-timepicker-basic></demo-timepicker-basic>
  </ng-sample-box>
      
  <h3 routerLink="." fragment="meridian" id="meridian">Meridian</h3>
  ...
  <h3 routerLink="." fragment="seconds" id="seconds">Show seconds</h3>
  ...
  <h3 routerLink="." fragment="custom" id="custom">Custom steps</h3>
  <ng-sample-box [ts]="demos.custom.component" [html]="demos.custom.html">
    <demo-timepicker-custom></demo-timepicker-custom>
  </ng-sample-box> 
                      
  <h3 routerLink="." fragment="custom-validation" id="custom-validation">Custom validation</h3>
  ...
  <h3 routerLink="." fragment="mouse-wheel" id="mouse-wheel">Mouse wheel and Arrow keys</h3>
