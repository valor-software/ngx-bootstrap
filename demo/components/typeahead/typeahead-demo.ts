...
export class TypeaheadDemoComponent {
  ...
  public dataSourceDelayed: Observable<any>;
  public asyncSelected: string = '';
  public asyncSelected2: string = '';
  ...
  public constructor() {
    ...
    this.dataSourceDelayed = Observable.create((observer: any) => {
      // Runs on every search
      setTimeout(() => {
        observer.next(this.asyncSelected2);
      }, 1000);
