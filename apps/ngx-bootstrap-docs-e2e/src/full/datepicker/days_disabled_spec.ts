...
describe('Datepicker demo testing suite: Days disabled', () => {
  ...
  it(`when user clicks on 1 Datepicker, then it opened, user can chose date except Saturday and Sunday
                   when user clicks on any Saturday or Sunday, nothing happens, they are disabled`, { scrollBehavior: 'center' }, () => {
  ...
  it(`when user clicks on any active date in 1 datepicker, this date chosen and shown "mm/dd/yyyy"`, { scrollBehavior: 'center' }, () => {
    datepicker.clickOnDatepickerInput(daysDisabled, 0);
  ...
  it(`when user clicks on the second Datepicker, then container opened and user can chose any date`, { scrollBehavior: 'center' }, () => {
  ...
  it(`when user clicks on any Saturday or Sunday, this date chosen and shown in the input "mm/dd/yyyy"`, { scrollBehavior: 'center' }, () => {
    datepicker.clickOnDatepickerInput(daysDisabled, 1);
    datepicker.clickOnWeekDay(false);
