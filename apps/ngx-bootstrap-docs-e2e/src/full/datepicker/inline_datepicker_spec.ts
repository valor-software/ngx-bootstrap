...
describe('Datepicker demo testing suite: Inline Datepicker', () => {
  ...
  it(`when user clicks on any other date - then this date selected`, { scrollBehavior: 'center' }, () => {
  ...
  it(`when user chose another month and chose there any date - then this date selected`, { scrollBehavior: 'center' }, () => {
