...
describe('Modals demo page testing suite: Service examples', () => {
  ...
  //     "Close" button is present`, { scrollBehavior: 'center' }, () => {
  ...
  //   });
  //
  //   it('when user closes modal by clicking on "Close" button', { scrollBehavior: 'center' }, () => {
  //     modals.clickByText(componentDemo, btnText);
  ...
  //   });
  //
  //   it('when user clicks on "Close" button, triggers the interceptor and doesn\'t close the modal', { scrollBehavior: 'center' }, () => {
  //     modals.clickByText(interceptorDemo, btnText);
  //     modals.clickByText(modals.modalFooter, modalBtnClose);
  //     modals.checkElementsQuantity(modals.modalContainer, 2);
  //   });
  //
  //   it('when user clicks on "Yes" button, closes the modal', { scrollBehavior: 'center' }, () => {
  //     modals.clickByText(interceptorDemo, btnText);
  //     modals.clickByText(modals.modalFooter, modalBtnClose);
  ...
  //   });
  //
  //   it('when user clicks on "No" button, doesn\'t close the modal', { scrollBehavior: 'center' }, () => {
  //     modals.clickByText(interceptorDemo, btnText);
  //     modals.clickByText(modals.modalFooter, modalBtnClose);
  ...
  describe('Nested modals', () => {
    ...
    //   is opened, button "Open second modal" button is present`, { scrollBehavior: 'center' }, () => {
    ...
    it(`when user clicks on the button "Open second modal" then the second modal with title "Second modal" is opened,
        "Close self" is present`, { scrollBehavior: 'center' }, () => {
      modals.clickByText(nestedDemo, btnText);
    ...
    // it('when user clicks on the button "Close self" then the first modal is closed', { scrollBehavior: 'center' }, () => {
    //   modals.clickByText(nestedDemo, btnText);
    //   modals.clickByText(modals.modalBtn, open2ndModal);
  ...
  //     with 15 paragraphs`, { scrollBehavior: 'center' }, () => {
  //     modals.clickByText(scrollDemo, btnText);
  //     modals.checkElementsQuantity(modals.modalParagraph, 15);
  //   });
  //
  //   it('when user scroll content by mousewheel, content is scrolled successfully', { scrollBehavior: 'center' }, () => {
  //     modals.clickByText(scrollDemo, btnText);
  ...
  describe('Events', () => {
    ...
    //   "onShow event has been fired" and "onShown event has been fired"`, { scrollBehavior: 'center' }, () => {
    ...
    it(`when user closes modal by click on the cross then should be messages "onHide event has been fired"
      and "onHidden event has been fired"`, { scrollBehavior: 'center' }, () => {
      modals.clickByText(eventsDemo, btnText);
    ...
    // "onHide event has been fired" and "onHidden event has been fired"`, { scrollBehavior: 'center' }, () => {
    //     modals.clickByText(eventsDemo, btnText);
    //     modals.isModalVisible(modals.modalContainer, true);
  ...
  describe('Confirm Window', () => {
    ...
    it('when user clicks on "Open modal" button then modal is opened, it contains two buttons: "Yes" and "No"', { scrollBehavior: 'center' },
      () => {
    ...
    // it('when user clicks on "Yes" button then modal is closed, message "Confirmed!" is displayed', { scrollBehavior: 'center' }, () => {
    //   modals.clickByText(confirmDemo, btnText);
    ...
    // });
    //
    // it('when user clicks on "No" button then modal is closed, message "Declined!" is displayed', { scrollBehavior: 'center' }, () => {
    //   modals.clickByText(confirmDemo, btnText);
    ...
    // });
    //
    // it('when user clicks outside the modal then modal is closed, no message is displayed', { scrollBehavior: 'center' }, () => {
    //   modals.clickByText(confirmDemo, btnText);
    //   modals.clickOutside(modals.modalContainer);
    //   modals.isPreviewExist(confirmDemo, emptyPreview);
    // });
  ...
  describe('Custom css class', () => {
    ...
    // });
    //
    // it('when user clicks on "Open modal with custom css class" button then modal is opened', { scrollBehavior: 'center' }, () => {
  ...
  describe('Animation option', () => {
    ...
    // });
    //
    // it('when user clicks on "Open modal" button then modal is opened. it appears with animations effects', { scrollBehavior: 'center' }, () => {
    //   modals.clickByText(animationDemo, btnText);
    //   modals.isModalVisible(modals.modalContainer, true);
    // });
    //
    // it('when user clicks on "Disable animation" button then title of the button is changed to "Enable animation"', { scrollBehavior: 'center' },
    //   () => {
    //     modals.clickByText(animationDemo, btnDisable);
    //     modals.isButtonExist(animationDemo, btnEnable, 1);
    //   });
    //
    // it('after that click on "Open modal" button, modal is opened without animations effects', { scrollBehavior: 'center' }, () => {
    //   modals.clickByText(animationDemo, btnText);
    //   modals.isModalVisible(modals.modalContainer, true);
    // });
  ...
  describe('Esc closing option', () => {
    ...
    it(`when user clicks on "Open modal" button then modal is opened. when user closes modal by click
      ESC button then modal stays opened`, { scrollBehavior: 'center' }, () => {
    ...
    // it(`when user clicks on "Disable Esc" button then title of the button is changed to "Enable animation"`, { scrollBehavior: 'center' },
    //   () => {
    //     modals.clickByText(escapeDemo, btnDisable);
    ...
    it(`after that click on "Open modal" button, modal popup is opened. when user press ESC button then modal
      is closed`, { scrollBehavior: 'center' }, () => {
      modals.clickByText(escapeDemo, btnText);
      modals.pressEscModal();
      modals.isModalEnabled(modals.modalContainer, false);
    });
  ...
  describe('Modal window with tooltip and popover', () => {
    ...
    it(`when user clicks on "Open modal" button then modal is opened. the buttons "popover" and "tooltip"
       are present`, { scrollBehavior: 'center' }, () => {
    ...
    // it('when user clicks on "popup" button then a popup is shown', { scrollBehavior: 'center' }, () => {
    //   modals.clickByText(toolPopupDemo, btnText);
    //   modals.clickByText(modals.modalBody, btnPopover);
    //   modals.isElementVisible('body', modals.modalPopup);
    // });

    it(`when user hover on "tooltip" button then a popup is shown`, { scrollBehavior: 'center' },
      () => {
        modals.clickByText(toolPopupDemo, btnText);
  ...
  //   });
  //
  //   it('when user clicks on "Open modal" button then modal is opened, it can be closed by clicking on a backdrop', { scrollBehavior: 'center' },
  //     () => {
  ...
  //     that click on "Open modal" button, modal is opened, backdrop is closed`, { scrollBehavior: 'center' }, () => {
  ...
  //     after that open modal and close by click on backdrop then modal stays opened`, { scrollBehavior: 'center' }, () => {
  ...
  //      is present. the modal has width 300px and class "modal-dialog modal-sm"`, { scrollBehavior: 'center' },
  //     () => {
  ...
  //     the modal class changed to "modal-dialog modal-lg"`, { scrollBehavior: 'center' }, () => {
  //     modals.clickByText(classChangeDemo, btnText);
  //     modals.isModalVisible(modals.modalContainer, true);
