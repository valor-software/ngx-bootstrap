...
export const ngdoc: any = {
    ...
    outputs: [
      {
        ...
        type: 'AlertComponent',
        description:
          '<p>This event fires immediately after close instance method is called,\n$event is an instance of Alert component.</p>\n'
      },
      {
        name: 'onClosed',
        type: 'AlertComponent',
  ...
  CarouselComponent: {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: 'boolean',
        description:
          '<p>If <code>true</code> - carousel indicators indicate slides chunks\nworks ONLY if singleSlideOffset = FALSE</p>\n'
      },
      {
        name: 'interval',
        type: 'number',
      ...
      },
      {
        ...
        type: 'boolean',
        description:
          '<p>If <code>true</code> — carousel will not cycle continuously and will have hard stops (prevent looping)</p>\n'
      },
      {
        name: 'pauseOnFocus',
        type: 'boolean',
      ...
      },
      {
        ...
        type: 'boolean',
        description:
          '<p>If <code>true</code> — carousel shifts by one element. By default carousel shifts by number\nof visible elements (itemsPerSlide field)</p>\n'
      },
      {
        name: 'startFromIndex',
        defaultValue: '0',
        type: 'number',
        description: '<p>Index to start display slides from it</p>\n'
      }
    ],
    outputs: [
      {
    ...
    properties: [
      {
        ...
        type: 'boolean',
        description:
          '<p>If <code>true</code> - carousel indicators indicate slides chunks works ONLY if singleSlideOffset = FALSE</p>\n'
      },
      {
        name: 'interval',
        defaultValue: '5000',
  ...
  BsDatepickerInlineDirective: {
    ...
    inputs: [
      {
        name: 'bsConfig',
        type: 'Partial<BsDatepickerInlineConfig> | undefined',
  ...
  BsDatepickerDirective: {
    ...
    inputs: [
      ...
      {
        name: 'ignoreMinMaxErrors',
        type: 'boolean | undefined',
        description: '<p>Ignore validation errors when you reset to minDate or maxDate</p>\n'
      },
      {
        name: 'isDisabled',
        defaultValue: 'false',
      ...
      },
      {
        ...
        description:
          '<p>Placement of a datepicker. Accepts: &quot;top&quot;, &quot;bottom&quot;, &quot;left&quot;, &quot;right&quot;</p>\n'
      },
      {
        name: 'triggers',
        defaultValue: 'click',
    ...
    methods: [
      {
        name: 'show',
        description:
          '<p>Opens an element’s datepicker. This is considered a “manual” triggering of\nthe datepicker.</p>\n',
        args: [],
        returnType: 'void'
      },
      {
        name: 'hide',
        description:
          '<p>Closes an element’s datepicker. This is considered a “manual” triggering of\nthe datepicker.</p>\n',
        args: [],
        returnType: 'void'
      },
      {
        name: 'toggle',
        description:
          '<p>Toggles an element’s datepicker. This is considered a “manual” triggering\nof the datepicker.</p>\n',
        args: [],
        returnType: 'void'
      },
      {
  ...
  BsDaterangepickerInlineDirective: {
    ...
    inputs: [
      {
        name: 'bsConfig',
        type: 'Partial<BsDaterangepickerInlineConfig> | undefined',
        description: '<p>Config object for datepicker</p>\n'
      },
      {
        name: 'bsValue',
  ...
  BsDaterangepickerDirective: {
    ...
    inputs: [
      {
        name: 'bsConfig',
        type: 'Partial<BsDaterangepickerConfig> | undefined',
      ...
      },
      {
        ...
        type: '"right" | "top" | "bottom" | "left"',
        description:
          '<p>Placement of a daterangepicker. Accepts: &quot;top&quot;, &quot;bottom&quot;, &quot;left&quot;, &quot;right&quot;</p>\n'
      },
      {
        name: 'triggers',
        defaultValue: 'click',
  ...
  BsDaysCalendarViewComponent: {
    ...
    inputs: [
      ...
      {
        name: 'options',
        type: 'DatepickerRenderOptions | null | undefined',
        description: ''
      }
    ],
    outputs: [
    ...
    inputs: [
      {
        ...
        type: 'boolean | undefined',
        description:
          '<p>Indicates that dropdown will be closed on item or document click,\nand after pressing ESC</p>\n'
      },
      {
        name: 'container',
        type: 'string | undefined',
      ...
      },
      {
        ...
        type: 'boolean | undefined',
        description:
          '<p>This attribute indicates that the dropdown shouldn&#39;t close on inside click when autoClose is set to true</p>\n'
      },
      {
        name: 'isAnimated',
        defaultValue: 'undefined',
    ...
    properties: [
      {
        ...
        type: 'T | undefined',
        description:
          '<p>Reference to a component inside the modal. Null if modal&#39;s been created with TemplateRef</p>\n'
      },
      {
        name: 'hide',
        type: '() => void',
      ...
      {
        name: 'onHidden',
        type: 'EventEmitter<unknown> | undefined',
  ...
  ModalOptions: {
    ...
    properties: [
      ...
      },
      {
        ...
        type: 'CloseInterceptorFn | undefined',
  ...
  ModalDirective: {
    ...
    inputs: [
      ...
      },
      {
        name: 'config',
        defaultValue: 'undefined',
        type: 'ModalOptions<Record<string, unknown>> | undefined',
  ...
  PagerComponent: {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: 'number',
        description:
          '<p>maximum number of items per page. If value less than 1 will display all items on one page</p>\n'
      },
      {
        name: 'lastText',
        defaultValue: 'Last',
    ...
    outputs: [
      ...
      },
      {
        ...
        description:
          '<p>fired when page was changed, $event:{page, itemsPerPage} equals to\nobject with current page index and number of items per page</p>\n'
      }
    ],
    properties: [],
    methods: []
  ...
  PaginationComponent: {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: 'TemplateRef<PaginationLinkContext> | undefined',
      ...
      },
      {
        ...
        type: 'TemplateRef<PaginationNumberLinkContext> | undefined',
    ...
    outputs: [
      ...
      },
      {
        ...
        type: 'PageChangedEvent',
        description:
          '<p>fired when page was changed, $event:{page, itemsPerPage} equals to object\nwith current page index and number of items per page</p>\n'
      }
    ],
    properties: [],
    methods: []
  ...
  PaginationConfig: {
    ...
    properties: [
      {
        name: 'main.boundaryLinks',
        defaultValue: 'false',
        type: 'boolean',
        description: ''
      },
      {
        name: 'main.directionLinks',
        defaultValue: 'true',
        type: 'boolean',
        description: ''
      },
      ...
      {
        name: 'main.pageBtnClass',
        defaultValue: "''",
        type: 'string',
        description: ''
      },
      {
        name: 'main.previousText',
        defaultValue: 'Previous',
        type: 'string',
        description: ''
      },
      ...
      {
        name: 'pager.pageBtnClass',
        defaultValue: "''",
        type: 'string',
        description: ''
      },
      {
        name: 'pager.previousText',
        defaultValue: '« Previous',
        type: 'string',
        description: ''
      }
  ...
  PopoverDirective: {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: '"viewport" | "scrollParent" | "window" | undefined',
        description: ''
      },
      {
        name: 'container',
  ...
  BarComponent: {
    ...
    inputs: [
      ...
      },
      {
        ...
        description:
          '<p>provide one of the four supported contextual classes: <code>success</code>, <code>info</code>, <code>warning</code>, <code>danger</code></p>\n'
      },
      {
        name: 'value',
        defaultValue: '0',
  ...
  ProgressbarComponent: {
    ...
    inputs: [
      ...
      },
      {
        ...
        description:
          '<p>current value of progress bar. Could be a number or array of objects\nlike {&quot;value&quot;:15,&quot;type&quot;:&quot;info&quot;,&quot;label&quot;:&quot;15 %&quot;}</p>\n'
      }
    ],
    outputs: [],
    properties: [],
  ...
  RatingComponent: {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: 'string[]',
        description:
          '<p>array of icons titles, default: ([&quot;one&quot;, &quot;two&quot;, &quot;three&quot;, &quot;four&quot;, &quot;five&quot;])</p>\n'
      }
    ],
    outputs: [
      {
    ...
    outputs: [
      {
        ...
        type: 'unknown[]',
        description:
          '<p>fired on array change (reordering, insert, remove), same as <code>ngModelChange</code>.\nReturns new items collection as a payload.</p>\n'
      }
    ],
    properties: [],
    methods: []
  ...
  TabDirective: {
    ...
    inputs: [
      {
        ...
        defaultValue: 'undefined',
        type: 'boolean | undefined',
        description: '<p>tab active state - can be set via input</p>\n'
      },
      {
        name: 'customClass',
        defaultValue: 'undefined',
    ...
    outputs: [
      {
        ...
        type: 'TabDirective',
        description:
          '<p>fired when tab became inactive, $event:Tab equals to deselected instance of Tab component</p>\n'
      },
      {
        name: 'removed',
        type: 'TabDirective',
    ...
    properties: [
      ...
      },
      {
        ...
        type: 'string | undefined',
        description:
          '<p>tab id. The same id with suffix &#39;-link&#39; will be added to the corresponding &lt;li&gt; element</p>\n'
      },
      {
        name: 'removable',
        defaultValue: 'false',
      ...
      },
      {
        name: 'tabOrder',
        type: 'number | undefined',
        description: '<p>tab order for sorting when using dynamic tabs with *ngIf</p>\n'
      }
    ],
    methods: []
  },
  ...
  TooltipDirective: {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: 'AvailableBSPositions',
        description:
          '<p>Placement of a tooltip. Accepts: &quot;top&quot;, &quot;bottom&quot;, &quot;left&quot;, &quot;right&quot;</p>\n'
      },
      {
        name: 'tooltip',
    ...
    methods: [
      {
        name: 'toggle',
        description:
          '<p>Toggles an element&#39;s tooltip. This is considered a &quot;manual&quot; triggering of\nthe tooltip.</p>\n',
        args: [],
        returnType: 'void'
      },
      {
        name: 'show',
        description:
          '<p>Opens an element&#39;s tooltip. This is considered a &quot;manual&quot; triggering of\nthe tooltip.</p>\n',
        args: [],
        returnType: 'void'
      },
      {
        name: 'hide',
        description:
          '<p>Closes an element&#39;s tooltip. This is considered a &quot;manual&quot; triggering of\nthe tooltip.</p>\n',
        args: [],
        returnType: 'void'
      }
    ]
  ...
  TypeaheadDirective: {
    ...
    inputs: [
      ...
      },
      {
        ...
        type: 'TemplateRef<TypeaheadOptionListContext> | undefined',
        description:
          '<p>used to specify a custom options list template.\nTemplate variables: matches, itemTemplate, query</p>\n'
      },
      {
        name: 'typeahead',
        type: 'TypeaheadOptionArr | undefined',
        description:
          '<p>options source, can be Array of strings, objects or\nan Observable for external matching process</p>\n'
      },
      {
        name: 'typeaheadAsync',
        type: 'boolean | undefined',
        description:
          '<p>should be used only in case of typeahead attribute is Observable of array.\nIf true - loading of options will be async, otherwise - sync.\ntrue make sense if options array is large.</p>\n'
      },
      {
        name: 'typeaheadGroupField',
        type: 'string | undefined',
        description:
          '<p>when options source is an array of objects, the name of field that\ncontains the group value, matches are grouped by this field when set.</p>\n'
      },
      {
      ...
      },
      {
        ...
        type: 'TemplateRef<TypeaheadOptionItemContext> | undefined',
        description:
          '<p>used to specify a custom item template.\nTemplate variables exposed are called item and index;</p>\n'
      },
      {
      ...
      },
      {
        ...
        type: 'string',
        description:
          '<p>should be used only in case typeaheadSingleWords attribute is true.\nSets the word delimiter to match exact phrase.\nDefaults to simple and double quotes.</p>\n'
      },
      {
      ...
      },
      {
        ...
        type: 'boolean',
        description:
          '<p>Can be use to search words by inserting a single white space between each characters\nfor example &#39;C a l i f o r n i a&#39; will match &#39;California&#39;.</p>\n'
      },
      {
    ...
    outputs: [
      {
        ...
        type: 'boolean',
        description:
          '<p>fired when &#39;busy&#39; state of this component was changed,\nfired on async mode only, returns boolean</p>\n'
      },
      {
      ...
      },
      {
        ...
        type: 'TypeaheadMatch<any> | undefined',
    ...
    properties: [
      {
        ...
        type: 'string | undefined',
        description:
          '<p>if false don&#39;t focus the input element the typeahead directive is associated with on selection</p>\n'
      }
    ],
    methods: []
  },
