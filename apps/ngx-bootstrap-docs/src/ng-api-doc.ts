  ...
  "AccordionPanelComponent": {
    ...
    "inputs": [
      ...
      },
      {
        "name": "panelClass",
        "type": "string",
        "description": "<p>Provides an ability to use Bootstrap&#39;s contextual panel classes\n(<code>panel-primary</code>, <code>panel-success</code>, <code>panel-info</code>, etc...).\nList of all available classes [available here]\n(<a href=\"https://getbootstrap.com/common-docs/3.3/components/#panels-alternatives\" target=\"_blank\" title=\"undefined\">https://getbootstrap.com/common-docs/3.3/components/#panels-alternatives</a>)</p>\n"
      }
    ],
    "outputs": [
      {
