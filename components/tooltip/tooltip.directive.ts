...
export class TooltipDirective {
  ...
  public constructor(
    ...
    this.loader = loader;
    this.browserDomAdapter = new BrowserDomAdapter();
  }
  ...
  public show(): void {
    ...
    this.tooltip = this.loader
      ...
      if (this.appendToBody) {
        let tooltipElement = componentRef.location.nativeElement;
        this.browserDomAdapter.appendChild(this.browserDomAdapter.query('body'), tooltipElement);
      }
      return componentRef;
    });
  }
