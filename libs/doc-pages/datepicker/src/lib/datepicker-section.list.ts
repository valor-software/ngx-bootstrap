    ...
    content: [
      ...
      },
      {
        ...
        description: `
          ...
          <p>In the following example <code>datesDisabled</code> is set with an array to disable 2021-12-05 and 2021-12-09.</p>
          <p>Also, October is disabled for each year via <code>monthsDisabled</code> and 2023 is fully disabled via <code>yearsDisabled</code></p>
