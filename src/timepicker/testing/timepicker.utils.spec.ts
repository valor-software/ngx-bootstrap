...
describe('Runtime coverage. Utils: Timepicker', () => {
  ...
  it('should set time opts true', () => {
    const newDate: any = setTime(testTime(), modelTime(0, 0, 0));
  ...
  it('isInRange method should validate the date according to the max limit and return false', () => {
    const result = isInRange(testTime(18, 0, 0), controls.max, undefined);

    expect(result).toEqual(false);
  });

  it('isInRange method should validate the date according to the min limit and return false', () => {
    const result = isInRange(testTime(2, 0, 0), undefined, controls.min);

    expect(result).toEqual(false);
  });

  it('isInRange method should validate the date according to the limit and return true', () => {
    const result = isInRange(testTime(4, 0, 0), undefined, undefined);
  ...
  it('isInputLimitValid method should validate input according to the max limit and return false', () => {
    const date = modelTime(-1, 0, 0);
    const max = changeTime(new Date(), modelTime(0, -30, 0));
  ...
  it('isInputLimitValid method should validate input according to the limits and return true', () => {
    const result = isInputLimitValid(modelTime(1, 0, 0), void 0, void 0);
  ...
  it('setTime method should return correct time when entered string values', () => {
    const newDate: any = setTime(testTime(), modelTime('test', 'test', 'test'));
  ...
  it('setTime method should return correct time', () => {
    const newDate: any = setTime(testTime(), modelTime(23, 30, 40));
