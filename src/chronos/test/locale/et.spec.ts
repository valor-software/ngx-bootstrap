...
describe('locale: et', () => {
  ...
  it('parse', function () {
    var _tests = 'jaanuar jaan_veebruar veebr_märts märts_aprill apr_mai mai_juuni junni_juuli juuli_august aug_september sept_oktoober okt_november nov_detsember dets'.split('_'),
      i;
  ...
  it('now from now', function () {
    assertEq(moment().fromNow(), 'mõne sekundi tagasi', 'now from now should display as in the past');
  });
