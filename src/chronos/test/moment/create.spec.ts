...
describe('create', () => {
  ...
  */
  ...
  it('string with array of formats + ISO', function () {
    ...
    assert.equal(moment('17:15', [moment.ISO_8601, 'MM', 'HH:mm', 'YYYY']).hours(), 17, 'iso: assert parse HH:mm (1)');
    assert.equal(moment('24:15', [moment.ISO_8601, 'MM', 'kk:mm', 'YYYY']).hours(), 0, 'iso: assert parse kk:mm');
...
/*      moment.parseTwoDigitYear = function (input) {
  ...
  it('milliseconds', function () {
    assert.equal(moment('1', 'S').milliseconds(), 100);
    assert.equal(moment('12', 'SS').milliseconds(), 120);
    assert.equal(moment('123', 'SSS').milliseconds(), 123);
    assert.equal(moment('1234', 'SSSS').milliseconds(), 123);
    assert.equal(moment('12345', 'SSSSS').milliseconds(), 123);
    assert.equal(moment('123456', 'SSSSSS').milliseconds(), 123);
    assert.equal(moment('1234567', 'SSSSSSS').milliseconds(), 123);
    assert.equal(moment('12345678', 'SSSSSSSS').milliseconds(), 123);
    assert.equal(moment('123456789', 'SSSSSSSSS').milliseconds(), 123);
  });
