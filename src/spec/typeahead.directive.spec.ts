...
class TestTypeaheadComponent {
  ...
  statesValue: Subject<any> = new BehaviorSubject<any>(null);
...
describe('Directive: ', () => {
  ...
  describe('Typeahead', () => {
    ...
    describe('onBlur', () => {
      ...
      it('blur event should send the correct active item', () => {
        spyOn(fixture.componentInstance, 'onBlurEvent').and.callFake((param: any) => {
  ...
  describe('Typeahead', () => {
    const inputValue = `
    <input class="input" [(ngModel)]="selectedState"
           [typeahead]="statesValue">
  `;
    ...
    beforeEach(() => {
      ...
      TestBed.overrideComponent(TestTypeaheadComponent, {
        set: {template: inputValue}
      });
    ...
    describe('if gets null', () => {
      ...
      it('shoul not call typeaheadLoading',
        fakeAsync(() => {
          directive.ngOnInit();

          directive.typeaheadLoading.subscribe((value: any) => {
