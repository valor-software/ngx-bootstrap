...
describe('APIDocVisitor', function() {
  ...
  it('should extract basic info from directives and components', function() {
    ...
    expect(docs.Foo.fileName).toBe('misc/api-doc-testing-cases/directives-no-in-out.ts');
    ...
    expect(docs.Bar.fileName).toBe('misc/api-doc-testing-cases/directives-no-in-out.ts');
  ...
  it('should extract inputs info', function() {
    var inputDocs = apiDoc(['./misc/api-doc-testing-cases/directives-with-inputs.ts']).Foo.inputs;
  ...
  it('should extract input default value', function() {
    var inputDocs = apiDoc(['./misc/api-doc-testing-cases/directives-with-inputs-default-vals.ts']).Foo.inputs;
  ...
  it('should extract inferred types', function() {
    var inputDocs = apiDoc(['./misc/api-doc-testing-cases/directives-with-inputs-types-to-infer.ts']).Foo.inputs;
  ...
  it('should extract inputs info from setters', function() {
    var inputDocs = apiDoc(['./misc/api-doc-testing-cases/directives-with-tricky-inputs.ts']).Foo.inputs;
  ...
  it('should extract outputs info', function() {
    var outDocs = apiDoc(['./misc/api-doc-testing-cases/directives-with-outputs.ts']).Foo.outputs;
  ...
  it('should extract public methods info', function() {
    var methodDocs = apiDoc(['./misc/api-doc-testing-cases/directives-with-methods.ts']).Foo.methods;
  ...
  it('should not extract public methods info when annotated with @internal', function() {
    var methodDocs = apiDoc(['./misc/api-doc-testing-cases/component-with-internal-methods.ts']).Foo.methods;

    expect(methodDocs.length).toBe(0);
  });

  it('should extract documentation from services', function() {
    var serviceDocs = apiDoc(['./misc/api-doc-testing-cases/services-with-methods.ts']).ModalService;

    expect(serviceDocs.fileName).toBe('./misc/api-doc-testing-cases/services-with-methods.ts');
  ...
  it('should extract documentation of properties from services', function() {
    var serviceDocs = apiDoc(['./misc/api-doc-testing-cases/services-with-properties.ts']).ProgressbarConfig;
  ...
  it('should extract documentation from interfaces', function() {
    var interfaceDocs = apiDoc(['./misc/api-doc-testing-cases/interface-with-properties.ts']).NgbModalOptions;
  ...
  it('should extract method documentation from interfaces', function() {
    var interfaceDocs = apiDoc(['./misc/api-doc-testing-cases/interface-with-methods.ts']).SomeInterface;
  ...
  it('should extract documentation from documented classes', function() {
    var classDocs = apiDoc(['./misc/api-doc-testing-cases/class-with-doc.ts']).DocumentedFoo;
