...
import "typeahead/typeahead-demo.dart" show TypeaheadDemo;

var name = "Typeahead";

var src = "https://github.com/valor-software/ng2-bootstrap/blob/master/components/typeahead/typeahead.ts";
// webpack html imports
var doc = require("../../lib/typeahead/readme.md");

var titleDoc = require("../../lib/typeahead/title.md");

var ts = require("!!prismjs?lang=typescript!./typeahead/typeahead-demo.ts");

var html = require("!!prismjs?lang=markup!./typeahead/typeahead-demo.html");

@Component (selector: "typeahead-section")
@View (template: '''
  <br>
  ...
  ''', directives: const [ TypeaheadDemo, tabs, CORE_DIRECTIVES, NgNonBindable])
class TypeaheadSection {}