...
import "tooltip/tooltip-demo.dart" show TooltipDemo;

var name = "Tooltip";

var src = "https://github.com/valor-software/ng2-bootstrap/blob/master/components/tooltip/tooltip.ts";
// webpack html imports
var doc = require("../../lib/tooltip/readme.md");

var titleDoc = require("../../lib/tooltip/title.md");

var ts = require("!!prismjs?lang=typescript!./tooltip/tooltip-demo.ts");

var html = require("!!prismjs?lang=markup!./tooltip/tooltip-demo.html");

@Component (selector: "tooltip-section")
@View (template: '''
  <br>
  ...
  ''', directives: const [ TooltipDemo, tabs, CORE_DIRECTIVES, NgNonBindable])
