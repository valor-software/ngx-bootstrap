...
import "dropdown/dropdown-demo.dart" show DropdownDemo;

var name = "Dropdowns";

var src = "https://github.com/valor-software/ng2-bootstrap/blob/master/components/dropdown";
// webpack html imports
var doc = require("../../lib/dropdown/readme.md");

var titleDoc = require("../../lib/dropdown/title.md");

var ts = require("!!prismjs?lang=typescript!./dropdown/dropdown-demo.ts");

var html = require("!!prismjs?lang=markup!./dropdown/dropdown-demo.html");

@Component (selector: "dropdown-section")
@View (template: '''
  <br>
  ...
  ''', directives: const [ DropdownDemo, tabs, CORE_DIRECTIVES, NgNonBindable])
